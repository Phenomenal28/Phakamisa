...
public class DonationMyadapter extends RecyclerView.Adapter<DonationMyadapter.myviewholder>
{
    ...
    public DonationMyadapter(ArrayList<DonationModel> datalist) {
    ...
    public myviewholder onCreateViewHolder (@NonNull ViewGroup parent,int viewType){
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.donation_singlerow, parent, false);
