...
public class DonationReceive extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CollectionReference collectionReference = fStore.collection("donations user data");
                ...
                collectionReference.add(user)
                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                Intent intent = new Intent(DonationReceive.this, DonationMainActivity.class);
