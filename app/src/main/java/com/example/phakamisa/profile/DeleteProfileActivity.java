...
public class DeleteProfileActivity extends AppCompatActivity {
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                textViewAuthenticated.setText("You are authenticated/verified. You can delete your profile and related now!");
                                Toast.makeText(DeleteProfileActivity.this, "Password has been verified. You can delete your profile now. Be careful, this section is irreversible", Toast.LENGTH_SHORT).show();
    ...
    private void deleteUserData(FirebaseUser firebaseUser) {
        if(firebaseUser.getPhotoUrl() != null){
            ...
            storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void unused) {
                    Log.d(TAG, "Success: Photo Deleted");
                }
        ...
        databaseReference.child(firebaseUser.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Log.d(TAG, "Success:User Data Deleted");
                deleteUser();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
